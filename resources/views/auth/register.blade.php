                ...
                <div class="col-12 p-3 p-lg-4" style="background:#fff;border-radius: 10px;">
                    <form method="POST" action="{{ route('register') }}" id="register-form" class="row m-0 d-flex">
                        ...
                        <div class="form-group row mb-4 col-12 col-lg-12   px-0 pt-2 ">
                            <div class="col-md-12 px-2 pt-4" style="position: relative;">
                                <label for="phone" class="col-form-label text-md-right mb-1 font-small px-2 py-1 d-inline" style="background:#f4f4f4;position: absolute;top: 17px;right: 20px; border-radius: 3px!important">رقم الهاتف</label>
                                <input id="phone" type="text" class="form-control mt-2 d-inline-block @error('phone') is-invalid @enderror" name="phone" required="" autocomplete="off" autofocus="" style=";height: 42px;border-color: #eaedf1;border-radius: 3px!important" value="{{ old('phone') }}">
                            </div>
                            @error('email')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
